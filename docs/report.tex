...
Check README.md for detailed instructions on how to build and run the system.
...
Table \ref{tab:perf_results} shows the performance results from our evaluation, where we deployed different numbers of miners (1, 3, 5) with varying difficulty levels (15, 18, 20) and measured blocks mined in a 120-second window.
...
\textit{[Placeholder: Performance comparison between Merkle tree mode and legacy mode will be added after completing the evaluation.]}
...
\textit{[Placeholder: Screenshots and detailed feature descriptions will be added manually.]}
...
\textit{[Placeholder: Detailed performance analysis of UTXO bottleneck will be added after profiling.]}
